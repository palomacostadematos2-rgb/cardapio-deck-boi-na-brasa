...
function ProductCard({ product }: ProductCardProps) {
  return (
    <MotionLink
      ...
      whileTap={{ scale: 0.98 }}
      className={cn(
        'border-wood-800/60 bg-surface hover:border-wood-600 hover:shadow-brasa-600/10 flex h-full flex-col justify-between gap-3 rounded-2xl border p-4 transition-colors hover:shadow-lg',
        focusRingClasses,
      )}
    >
      <div>
